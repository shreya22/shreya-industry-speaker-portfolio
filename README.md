...
3. **Banner photo** — save a wide photo (on stage, speaking at a conference, etc.) as `public/images/banner1.jpg`. Until it exists, the full-width banner shows a placeholder block automatically.
